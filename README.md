...
| `ergonomics.html` | OSHA/NIOSH setup checklist for a small room + 12-hour-static-posture fixes |
| `products.html` | Foldable desks, chairs, monitor arm, pillows, rehab tools — official-page prices, 3 budget builds |
| `sources.html` | Master source list with trust tiers + verification log (all checked 2026-09-19) |
...
- **Pricing + official verified sources** — every product price was read from the official manufacturer page on
  2026-09-19 (retailer/affiliate sources are explicitly badged).
- **No hallucinations / line-by-line verification** — every claim carries a source chip linking to `sources.html`;
  the verification log records how and when each entry was checked; irregularities are flagged, not hidden.
...
- Product prices: read from official pages on 2026-09-19; they change — re-check before buying.
- Known irregularities from verification: see `docs/next-steps.html` (flagged table).
...
> **Disclaimer:** Informational content for personal use. Not medical advice. Consult a qualified clinician.
